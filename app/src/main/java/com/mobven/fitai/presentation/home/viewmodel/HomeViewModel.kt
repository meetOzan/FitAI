    ...
    private fun getSignUpSelectorList(
        ...
        _homeUiState.value = HomeUiState(
            ...
            when (fragmentType) {
                ...
                HomeFragmentType.GOALS -> listOf(
                    SignUpSelectorItem(
                        title = stringRes.getString(R.string.calorie_control),
                        isSelected = false,
                        type = SignUpSelectorType.RADIO
                    ),
                    SignUpSelectorItem(
                ...
                HomeFragmentType.OTHER_HEALTH_PROBLEM -> listOf(
                    SignUpSelectorItem(
                ...
                HomeFragmentType.PREFERRED_SPORT -> listOf(
                    SignUpSelectorItem(
                ...
                HomeFragmentType.SPORT_BODY -> listOf(
                    SignUpSelectorItem(
                        title = stringRes.getString(R.string.all),
                        isSelected = false,
                        type = SignUpSelectorType.CHECKBOX
                ...
                HomeFragmentType.SPORT_OFTEN -> listOf(
                    SignUpSelectorItem(
